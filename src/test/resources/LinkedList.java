...
class LL{
    ...
    public int Start(){
        ...
        el01 = new Element();
        aux01 = el01.Init(25,370,false);
        head = head.Insert(el01);
        aux01 = head.Print();
        System.out.println(1000);
        // inserting second  element
        el01 = new Element();
        aux01 = el01.Init(39,420,true);
        el02 = el01 ;
        head = head.Insert(el01);
        aux01 = head.Print();
        System.out.println(1000);
