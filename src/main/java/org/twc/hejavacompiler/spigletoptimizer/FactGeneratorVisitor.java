...
import org.twc.hejavacompiler.spiglet2kanga.spigletsyntaxtree.*;
import org.twc.hejavacompiler.spiglet2kanga.spigletvisitor.*;
import org.twc.hejavacompiler.spigletoptimizer.factsgen.*;
...
public class FactGeneratorVisitor extends GJDepthFirst<String, String> {
     ...
     * f2 -> Exp()
     */
    public String visit(EConstStmt n, String argu) throws Exception {
        String dst = n.f1.accept(this, argu);
        String idx = n.f2.accept(this, argu);
        String op = "E_CONST " + dst + ", " + idx;
